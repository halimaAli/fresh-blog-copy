...
const SLIDE_DATA = [
  {
    color: "bg-green-300",
    text: "slide one",
    url: asset("/carousel/fresh.png"),
  },
  {
    color: "bg-yellow-300",
    text: "slide two",
    url: asset("/carousel/lemons.jpg"),
  },
  {
    color: "bg-blue-300",
    text: "slide three",
    url: asset("/carousel/deno_news.png"),
  },
  {
    color: "bg-yellow-300",
    text: "slide four",
    url: asset("/carousel/brachiosaurus.jpg"),
  },
];
...
const Slide = (props: SlideProps) => {
  ...
  return (
    <div
      key={key}
      class={`${props.class} ${color} mx-auto h-80 w-full`}
    >
      <img class="w-full" src={url} alt={text} />
    </div>
  );
};
